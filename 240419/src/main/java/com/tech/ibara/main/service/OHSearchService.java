...
public class OHSearchService implements MainSearchService {
	
	private SqlSession sqlSession;

	public OHSearchService(SqlSession sqlSession) {
	...
	public void execute(Model model) {
		...
		ArrayList<OHSearchDto> ohSearchList = dao.ohSearchContent(mainSearchContent);
		model.addAttribute("ohSearchList", ohSearchList);
