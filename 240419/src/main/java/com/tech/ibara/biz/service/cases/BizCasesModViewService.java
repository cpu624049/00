...
@Service
public class BizCasesModViewService implements BizServiceInter {

	private SqlSession sqlSession;
	
	public BizCasesModViewService(SqlSession sqlSession) {
	...
	public void execute(Model model) {
		...
		System.out.println("service BizCasesModViewService>>>");
