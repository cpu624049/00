...
@Service
public class BizMgzModViewService implements BizServiceInter {

	private SqlSession sqlSession;
	
	public BizMgzModViewService(SqlSession sqlSession) {
	...
	public void execute(Model model) {
		...
		System.out.println("service BizMgzModViewService>>>");
