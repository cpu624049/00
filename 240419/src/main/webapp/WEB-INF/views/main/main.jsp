...
<body>
	...
	<header>
		...
		<div class="header_top">
			...
			<div class="header_logo">
				<img src="resources/img/mainimg/logo_1_small_1459x344.jpg" alt="#" onclick="location.href='main'" />
			</div>
			<!-- header_search_box : 검색창 -->
			<div class="header_search_box">
				<form action="main/mainSearchView" method="get">
		...
		<div id="header_bottom" class="header_bottom">
			...
			<div class="header_category_list list_3">
				<a href="biz/search/bizAddrSearch">업체 둘러보기</a>
			</div>
	...
	<div class="body_section">
		...
		<div id="category_button" class="category_button_wrap">
			...
			<button onclick="location.href='biz/search/bizAddrSearch'" id="category_button" class="category_button category_3">
				<span>업체 <br> 둘러보기
				</span>
			</button>
		...
		<div class="main_preview_wrap">
			<div class="main_preview">
				<h1 class="main_preview_title"><a href="biz/search/bizAddrSearch">입점 업체 보기</a></h1>
				<hr />
						...
						<div class="main_preview_biz_list">
							<ul>
								<li class="main_preview_biz_img">
									<img src="resources/upload/main/${biz.biz_img }" alt="#" onclick="location.href='biz/search/bizAddrSearch'" />
								</li>
							</ul>
							<ul>
								<li class="main_preview_biz_name"><a href="biz/search/bizAddrSearch">${biz.biz_name }</a></li>
							</ul>
							<ul>
								<li class="main_preview_biz_addr"><a href="biz/search/bizAddrSearch">${biz.biz_addr }</a></li>
							</ul>
						</div>
					</c:forEach>
				</div>
						...
						<div class="main_preview_shop_list">
							<ul>
								<li class="main_preview_shop_img">
									<img src="resources/upload/main/${shop.shop_img }" alt="#" onclick="location.href='shop/list'" />
								</li>
							</ul>
							<ul>
								<li class="main_preview_shop_name"><a href="shop/list">${shop.shop_name }</a></li>
							</ul>
							<ul>
								<li class="main_preview_shop_price"><a href="shop/list">\ ${shop.shop_price }</a></li>
							</ul>
						</div>
					</c:forEach>
				</div>
						...
						<div class="main_preview_OH_list">
							<ul>
								<li class="main_preview_OH_img">
									<img src="resources/upload/main/${oh.oh_img }" alt="#" onclick="location.href='oh/OHMainView'" />
								</li>
							</ul>
							<ul>
								<li class="main_preview_OH_name"><a href="oh/OHMainView">${oh.oh_name }</a></li>
							</ul>
							<ul>
								<li class="main_preview_OH_content"><a href="oh/OHMainView">${oh.oh_content }</a></li>
							</ul>
						</div>
					</c:forEach>
				</div>
				...
				<div class="main_preview_cs_notice">
					...
					<div class="main_preview_cs_notice_board">
						...
						<c:forEach items="${noticePreviewList }" var="notice">
							<ul>
								<li class="main_preview_cs_notice_category w10"><a href="noticelist">${notice.notice_no }</a></li>
								<li class="main_preview_cs_notice_category w30"><a href="noticelist">${notice.notice_title }</a></li>
								<li class="main_preview_cs_notice_category w20"><a href="noticelist">${notice.notice_writer }</a></li>
								<li class="main_preview_cs_notice_category w15"><a href="noticelist">${notice.notice_hit }</a></li>
								<li class="main_preview_cs_notice_category w24"><a href="noticelist">${notice.notice_date }</a></li>
							</ul>
						</c:forEach>
					</div>
				</div>
				<div class="main_preview_cs_qna">
					...
					<div class="main_preview_cs_qna_board">
						...
						<c:forEach items="${qnaPreviewList }" var="qna">
							<ul>
								<li class="main_preview_cs_qna_category w10"><a href="qnalist">${qna.qna_no }</a></li>
								<li class="main_preview_cs_qna_category w30"><a href="qnalist">${qna.qna_title }</a></li>
								<li class="main_preview_cs_qna_category w20"><a href="qnalist">${qna.qna_writer }</a></li>
								<li class="main_preview_cs_qna_category w15"><a href="qnalist">${qna.qna_hit }</a></li>
								<li class="main_preview_cs_qna_category w24"><a href="qnalist">${qna.qna_date }</a></li>
							</ul>
						</c:forEach>
					</div>
				</div>
	...
	<footer>
		...
		<div class="footer_logo">
			<img src="resources/img/mainimg/logo_3_1500x1500.jpg" alt="#" onclick="location.href='main'"  />
		</div>
		<!-- 푸터 내용 -->
